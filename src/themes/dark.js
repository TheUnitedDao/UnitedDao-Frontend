...
const darkTheme = {
  ...
  background: `
      linear-gradient(180deg, rgba(0, 0, 0, 0.9), rgba(129, 216, 208, 0.8)),
      linear-gradient(333deg, rgba(153, 207, 255, 0.2), rgba(180, 255, 217, 0.08)),
      radial-gradient(circle at 77% 89%, RGBA(129, 216, 208, 0.6), rgba(125, 163, 169, 0) 50%),
      ...
      radial-gradient(circle at 10% 0%, RGBA(129, 216, 208, 0.4), rgba(187,211,204,0) 35%),
      radial-gradient(circle at 11% 100%, rgba(131, 165, 203, 0.3), rgba(131, 165, 203, 0) 30%)
      `,
  paperBg: "linear-gradient(237.43deg, #0ABAB5 -12.81%, #171A20 132.72%)",
  modalBg: "#24242699",
  ...
  primaryButtonColor: "#006A67",
  primaryButtonBG: "#F4D092",
  primaryButtonHoverBG: "#RGB(129, 216, 208)",
  secondaryButtonHoverBG: "RGB(129, 216, 208)",
  outlinedPrimaryButtonHoverBG: "#66F3ED",
  outlinedPrimaryButtonHoverColor: "#006A67",
  outlinedSecondaryButtonHoverBG: "transparent",
  outlinedSecondaryButtonHoverColor: "#66F3ED", //gold
    ...
    deepmerge(
      {
        ...
        palette: {
          ...
          neutral: {
            main: darkTheme.color,
            secondary: darkTheme.black,
          },
          text: {
            primary: darkTheme.color,
            secondary: darkTheme.tiffany,
          },
