...
const Calculator: FC = () => {
  ...
  const totalsUNITED = (1 + rebaseRate) ** rebases * initialInvestment;
  const sohmProfit = totalsUNITED - initialInvestment;
  const pieValue = (sohmProfit / totalsUNITED) * 100;
  useEffect(() => {
  ...
  return (
    <StyledFade in={true}>
      <Box>
          ...
          {!advanced && (
            <>
              ...
              <Box display="flex" justifyContent="center" mb="18px">
                <Typography className={classes.investmentAmount}>{formattedInitialInvestment} UNITED</Typography>
              </Box>
          ...
          <>
            <Box display="flex" justifyContent="space-around" alignItems="center" mt="18px" mb="18px">
              <Box display="flex" flexDirection="column" textAlign="right" flexGrow={0.33}>
                <Typography className={classes.progressMetric}>{formattedInitialInvestment} UNITED</Typography>
                <Typography className={classes.progressLabel}>Invested</Typography>
              </Box>
              <Box position="relative">
                <ProgressCircle balance={formatNumber(totalsUNITED, 2)} label="Total UNITED" progress={pieValue} />
              </Box>
              <Box display="flex" flexDirection="column" textAlign="left" flexGrow={0.33}>
                <Typography className={classes.progressMetric}>{formattedProfits} UNITED</Typography>
        ...
        <DottedDataRow title="Initial Investment" value={`${formattedInitialInvestment} UNITED`} />
        ...
        <DottedDataRow title="Total sUNITED" value={formatNumber(totalsUNITED, 2)} bold />
