...
export const TransactionHistory: FC = () => {
  ...
  const ohmTransfers = useTransferHistory(UNITED_TOKEN);
  const gohmTransfers = useTransferHistory(GUNITED_TOKEN);
  const sohmTransfers = useTransferHistory(SUNITED_TOKEN);
  const wsohmTransfers = useTransferHistory(WSUNITED_TOKEN);
  const v1ohmTransfers = useTransferHistory(V1_UNITED_TOKEN);
  const v1sohmTransfers = useTransferHistory(V1_SUNITED_TOKEN);
