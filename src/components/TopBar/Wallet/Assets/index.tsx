...
export interface UNITEDAssetsProps {
  path?: string;
}
const AssetsIndex: FC<UNITEDAssetsProps> = (props: { path?: string }) => {
  ...
  const tokenArray = [
    {
      symbol: ["UNITED"] as OHMTokenStackProps["tokens"],
    ...
    {
      symbol: ["sUNITED"] as OHMTokenStackProps["tokens"],
      ...
      lineThreeValue:
        Number(formattedSOhmBalance) > 0
          ? `${trim(rebaseAmountPerDay, 3)} sUNITED / ${formatCurrency(rebaseAmountPerDay * ohmPrice, 2)}`
          : undefined,
    },
    {
      symbol: ["sUNITED"] as OHMTokenStackProps["tokens"],
      ...
      <Box>
        <Box display="flex" flexDirection="row" justifyContent="space-between">
          <WalletBalance
            ...
            underlyingBalance={`${formatNumber(walletTotalValueUSD / (ohmPrice !== 0 ? ohmPrice : 1), 2)} UNITED`}
          />
        </Box>
          ...
          <>
            ...
            <Box display="flex" flexDirection="row" justifyContent="space-between" mt="18px">
              <FormControl className={classes.faucet}>
                ...
                >
                  <MenuItem value="UNITED V1">UNITED V1</MenuItem>
                  <MenuItem value="UNITED V2">UNITED V2</MenuItem>
                  <MenuItem value="sUNITED V1">sUNITED V1</MenuItem>
                  <MenuItem value="sUNITED V2">sUNITED V2</MenuItem>
