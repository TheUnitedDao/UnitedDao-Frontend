    ...
    <Fade in={true}>
      <StyledBox>
        ...
        <Grid container spacing={1}>
          <Grid item xs={6}>
            <GetOnButton
              href={`https://app.sushi.com/swap/?outputCurrency=${UNITED_ADDRESSES[NetworkId.MAINNET]}`}
          ...
          <Grid item xs={6}>
            <GetOnButton
              href={`https://app.uniswap.org/#/swap?outputCurrency=${UNITED_ADDRESSES[NetworkId.MAINNET]}`}
        ...
        <ItemCard
          ...
          href={`https://jonesdao.io/vaults/gUNITED`}
          networkName="ARBITRUM"
          external
          disableFlip
        />
