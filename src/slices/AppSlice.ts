...
import { SUNITED_ADDRESSES, STAKING_ADDRESSES } from "src/constants/addresses";
import { Providers } from "src/helpers/providers/Providers/Providers";
import { RootState } from "src/store";

import sUNITEDv2 from "../abi/sOhmv2.json";
...
/**
 * - fetches the UNITED price from CoinGecko (via getTokenPrice)
