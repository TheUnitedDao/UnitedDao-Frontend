...
export class Environment {
   ...
   *
   * Defaults to false. Only true when the `mock_sohm` query param is present or `REACT_APP_MOCK_SUNITED_ENABLED` === "true"
   */
  public static isMockSohmEnabled(url: string) {
    const isQueryParamActive = url.includes("mock_sohm");
    const isEnvTrue = this.env.REACT_APP_MOCK_SUNITED_ENABLED === "true";
