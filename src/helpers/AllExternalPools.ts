...
export const beets_ftm_gohm_wFTM = new ExternalPool({
  poolName: "gUNITED-wFTM",
  icons: ["gUNITED", "FANTOM"],
  stakeOn: "Beethoven",
  pairGecko: "fantom",
...
export const balancer_ohm_dai_weth = new ExternalPool({
  poolName: "UNITED-DAI-wETH",
  icons: ["UNITED", "DAI", "wETH"],
  stakeOn: "Balancer",
  pairGecko: "ethereum",
  rewardGecko: "gUNITED",
...
export const spirit_gohm_ftm = new ExternalPool({
  poolName: "gUNITED-FTM",
  icons: ["wsUNITED", "FANTOM"],
  stakeOn: "Spirit",
  pairGecko: "fantom",
...
export const jones_gohm_jgohm = new ExternalPool({
  poolName: "jgUNITED-gUNITED",
  icons: ["jgUNITED", "gUNITED"],
  stakeOn: "Jones DAO",
