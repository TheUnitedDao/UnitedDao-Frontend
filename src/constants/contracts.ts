...
export const OP_BOND_DEPOSITORY_CONTRACT = new Contract({
  ...
  name: "United Pro Bond Depository Contract",
...
export const FIATDAO_WSUNITED_CONTRACT = new Contract({
  factory: FiatDAOContract__factory,
  name: "FiatDAO Contract",
  addresses: FIATDAO_WSUNITED_ADDRESSES,
});
