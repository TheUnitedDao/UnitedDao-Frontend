...
export const tooltipInfoMessages = () => {
  return {
    tvl: t`Total Value Deposited, is the dollar amount of all UNITED staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.`,
    liqb: t`Liquid treasury is the dollar amount of stablecoins, volatile assets and protocol-owned liquidity in the treasury, excluding UNITED. This excludes the value of any illiquid (vesting/locked) assets.
    
    It represents the budget the Treasury has for specific market operations which cannot use UNITED (inverse bonds, some liquidity provision, UNITED incentives, etc).`,
    ...
    rfv: t`Risk Free Value, is the amount of funds the treasury guarantees to use for backing UNITED.`,
    ...
    holder: t`Holders, represents the total number of Ohmies (sUNITED holders)`,
    staked: t`UNITED Staked is the ratio of sUNITED to circulating supply of UNITED (staked vs total)`,
    ...
    runway: t`Runway, is the number of days sUNITED emissions can be sustained at a given rate. Lower Annualized Rebases  = longer runway`,
  };
};
