...
const MetricsDashboard = () => (
  <>
    <Box className="hero-metrics">
      <Paper className="UNITED-card">
        <MetricCollection>
          <MarketCap {...sharedMetricProps} />
          <UNITEDPriceFromSubgraph {...sharedMetricProps} />
          <GUNITEDPrice {...sharedMetricProps} className="wsoprice" />
          <CircSupply {...sharedMetricProps} />
          <BackingPerUNITED {...sharedMetricProps} />
        ...
        <>
          ...
          >
            ...
            {/* <Link to="/dashboard/olympuspro" component={NavLink}>
              <Tab label={t`United Pro`} style={{ whiteSpace: "nowrap" }} />
            </Link>
