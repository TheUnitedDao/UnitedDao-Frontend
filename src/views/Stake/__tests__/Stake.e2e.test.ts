...
describe.skip("Staking", () => {
  ...
  it("staking", async () => {
    ...
    // Staked balance should be written as 0.1 sUNITED
    expect(await getSelectorTextContent(page, "#user-staked-balance")).toEqual("0.1 sUNITED");
  ...
  it("unstaking", async () => {
    ...
    // Staked balance should be written as 0.0 sUNITED
    expect(await getSelectorTextContent(page, "#user-staked-balance")).toEqual("0 sUNITED");
  });
});
